...
export default function ChatPromoCard() {
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 flex flex-col justify-between h-full relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#2c4a3e] opacity-5 rounded-full translate-x-1/3 -translate-y-1/3 blur-2xl"></div>

            <div>
                <div className="flex items-center gap-3 mb-4">
                    <h2 className="text-2xl font-bold text-[#2c4a3e]">Meet Your 24/7 Deal Assistant</h2>
                    <span className="bg-green-100 text-[#2c4a3e] text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider flex items-center gap-1">
                        <Sparkles size={10} />
                        Powered by Gemini 3
                    </span>
                </div>
            ...
            <button
                ...
                className="inline-flex items-center gap-2 bg-[#2c4a3e] text-white px-6 py-3 rounded-lg font-bold hover:bg-[#1a2f27] transition-all self-start"
            >
